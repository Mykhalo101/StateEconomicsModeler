...
header <<- dashboardHeader( 
  ...
  title = span("PEI Model",style = "width: 80px; max-width: 10%; margin:0px 0px 0px 30px; padding: 0px; font-family:Times;font-size: 20px;position:relative;display:right-align"),
                           ...
                           tags$li(div(uiOutput("zerobtn"),style = "padding-top:5px; padding-right:100px;"),class = "dropdown"),
...
ui<-dashboardPage(header, sidebar, body,skin="blue", title = "PEIM 3.0"
)#shinydashboard=TRUE) #skin = "blue")
